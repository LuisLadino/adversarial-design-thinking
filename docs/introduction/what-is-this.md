...
Practical exercises adapted from human-centered design for adversarial testing of AI systems. Generate better attack ideas, document what you tried, communicate what you found.

## Design thinking applied to red teaming
...
**[Crafting Prompts](/crafting-prompts)** — Prompt anatomy, composition workflow, reusable patterns. Start here if new to adversarial prompting.

**[Exercises](/exercises)** — UX origin, when to use, and community templates for each.

**[Technique Reference](/techniques)** — Specific attack methods organized by category with research citations and effectiveness notes.

**[Workshop](/workshops/red-team-kickoff)** — Full facilitated flow: target profiling, persona creation, ideation, and journey mapping in one session.

## Exercises by workflow phase
